...
let referenceBinaries = [ "git-backup\\git-backup.exe" ]
// Web site location for the generated documentation
let website = "/git-backup"

let githubLink = "http://github.com/exira/git-backup"

// Specify more information about your project
let info =
  [ "project-name", "git-backup"
    "project-author", "exira"
    "project-summary", "Exira.GitBackup is a console application which backs up Git repositories on a rotating schedule"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Exira.GitBackup" ]
